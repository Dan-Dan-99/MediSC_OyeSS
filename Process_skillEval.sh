...
IMAGE_DIR="/input"
cp /output/gt/* /workspace/TrackEval/data/gt

process_image()
{
    local image_file=$1

    python /workspace/MediSC_OyeSS/demo/topdown_demo_with_mmdet.py /workspace/MediSC_OyeSS/configs/Co-DETR_hands_plz_copy.py /workspace/MediSC_OyeSS/configs/hand_best_coco_bbox_mAP_epoch_100_b16.pth /workspace/MediSC_OyeSS/configs/hand_pose_m.py /workspace/MediSC_OyeSS/configs/hand_pose_best_coco_AP_epoch_190.pth --input "$image_file" --det-cat-id 0 --save-predictions --output-root /workspace/MediSC_OyeSS/results/0_left_hand
...
cp /workspace/TrackEval/data/out/* /output
